...
* **Smart TTS Generation:**
    ...
    * Features a **"Cascading Fallback"** system (Line -> Sentence -> Forced Split) to handle long text chunks without crashing.
...
```bash
git clone [https://github.com/yourusername/auto-audiobook-pipeline.git](https://github.com/yourusername/auto-audiobook-pipeline.git)
