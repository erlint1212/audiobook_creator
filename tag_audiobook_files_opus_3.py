...
VOLUME_CONFIG = [
    ...
    },
    {
        ...
        "end_ch": 188,    # Example: Please verify/adjust (e.g., if ch_110.opus is the last of Vol 3)
        "disc_num": "3",
        "cover_art_file": "cover_art/tileasworries3.jpg"
    },
    {
        "name_suffix": "Volume 4 – Camilla Academy Arc",
        "start_ch": 189,  # Example: Please verify/adjust (e.g., if ch_111.opus is the first of Vol 4)
        "end_ch": float('inf'), # Assumes this is the last volume
        "disc_num": "4",
        "cover_art_file": "cover_art/tileasworries3.jpg" # Example: Add path to cover for Vol 4
    },
]
