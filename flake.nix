    ...
    in
    {
      devShells.${system}.default = pkgs.mkShell {
        ...
        shellHook = ''
          ...
          export LD_LIBRARY_PATH=/run/opengl-driver/lib:${ccLib.lib}/lib:${pkgs.libsndfile.out}/lib:${pkgs.zlib}/lib:${pkgs.cudaPackages.cudatoolkit}/lib:${pkgs.tk}/lib:${pkgs.tcl}/lib''${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}
