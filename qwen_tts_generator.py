...
AUDIO_OUTPUT_DIR = os.getenv("PROJECT_AUDIO_WAV_DIR", os.path.join(BASE_DIR, "generated_audio_HalfLight"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rvc_model_path", type=str, required=True, help="Path to your .pth file")
    parser.add_argument("--rvc_index_path", type=str, required=True, help="Path to your .index file")
    parser.add_argument("--pitch", type=int, default=-2, help="Pitch shift (try -12 for deep voices)")
